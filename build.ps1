...
# language
pylupdate5 .\View\main_window\ui_main.py ./View/tab_unit/ui_tab_unit.py ./View/tab_dev/ui_tab_dev.py ./View/sub_parse_index/ui_parse_index.py -ts .\resource\i18n\ptool.zh_CN.ts
