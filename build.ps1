...
pyuic5.exe ./View/sub_splicing/splicing.ui -o ./View/sub_splicing/ui_splicing.py -x
pyuic5.exe ./View/help_widget/help.ui -o ./View/help_widget/ui_help.py -x

# language
# pylupdate5 .\View\main_window\ui_main.py ./View/tab_unit/ui_tab_unit.py ./View/tab_dev/ui_tab_dev.py ./View/sub_parse_index/ui_parse_index.py ./View/help_widget/ui_help.py ./View/sub_splicing/ui_splicing.py -ts .\resource\i18n\ptool.zh_CN.ts
pylupdate5 `
  .\View\main_window\ui_main.py `
  ./View/tab_unit/ui_tab_unit.py `
  ./View/tab_dev/ui_tab_dev.py `
  ./View/sub_parse_index/ui_parse_index.py `
  ./View/help_widget/ui_help.py `
  ./View/sub_splicing/ui_splicing.py `
  -ts .\resource\i18n\ptool.zh_CN.ts 
